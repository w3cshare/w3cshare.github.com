...
export class ClientService implements OnModuleInit, OnModuleDestroy {
  ...
  private readonly serviceId = 'nest-template';
  private readonly serviceName = 'nest-template';
    ...
    try {
      ...
      await this.consul.agent.service.register({
        ...
        check: {
          ...
          http: `http://${this.serviceAddressCheck}:${this.servicePort}/health`,
          interval: '10s',
          timeout: '5s',
        },
      });

import{_ as n,c as a,o as p,a2 as e}from"./chunks/framework.D30IVGRC.js";const b=JSON.parse('{"title":"Docker Compose","description":"","frontmatter":{},"headers":[],"relativePath":"_docker-compose/README.md","filePath":"_docker-compose/README.md","lastUpdated":1746537478000}'),l={name:"_docker-compose/README.md"};function r(c,s,o,i,t,u){return p(),a("div",null,s[0]||(s[0]=[e(`<h1 id="docker-compose" tabindex="-1">Docker Compose <a class="header-anchor" href="#docker-compose" aria-label="Permalink to &quot;Docker Compose&quot;">​</a></h1><p><a href="https://cr.console.aliyun.com/cn-hangzhou/instances/mirrors" target="_blank" rel="noreferrer">镜像加速器</a></p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>{</span></span>

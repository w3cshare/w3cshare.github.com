 ...
 * @LastEditTime: 2025-04-10 10:52:29
 * @FilePath: /FullStack/lint/eslint-plugin-smarts/src/rules/recommended-rules-haWei1.ts:
 * @Description: eslint 拓展推荐配置 for haWei javascript 通用配置
 */

// eslint-config-huawei

// https://github.com/sept08/eslint-config-huawei/blob/master/index.js
export default {
  /**
   * Possible Errors
